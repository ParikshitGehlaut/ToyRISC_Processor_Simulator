...
public class OperandFetch {
	...
	public boolean isHazard(int rs1, int rs2) {
	...
	public void conflictObserved() {
		System.out.println("Hazard occurs and locking EX, MA and RW");
	...
	public void performOF() {
		if (IF_OF_Latch.isOF_enable()) {
			// fetching instructions from IF_OF_Latch
			...
			switch (CO) {
				...
				case sra:
					...
					// Checking is there is any data hazard
					if (isHazard(registerSource1, registerSource2)) {
				...
				case bgt:
					...
					// Checking is there is any data hazard
					if (isHazard(registerSource1, registerSource2)) {
						// increasing number of OF stalls by 1
						Statistics.setNumberOfOFUnitStalls(Statistics.getNumberOfOFUnitStalls() + 1);
						this.conflictObserved();
						break;
					}
				...
				default:
					...
					rd.setValue(registerDestination);
					// Checking is there is any data hazard
					if (isHazard(registerSource1, registerSource1)) {
						Statistics.setNumberOfOFUnitStalls(Statistics.getNumberOfOFUnitStalls() + 1);
						this.conflictObserved();
						break;
					}
			...
			System.out.println(" Current PC: " + currentPC + " Instruction: " + binaryInstruction
					+ " rs1: " + registerSource1 + " rs2: " + registerSource2);
